        ...
        <div class="header-body text-center mb-1">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              ...
              <p class="text-white">Type in the email you used for registeration</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="card bg-secondary border-0 mb-0">
            <div class="card-body px-lg-5 py-lg-5">
              <div class="text-center mb-4">
                <img src="assets/img/logo.png" class="img-fluid" style="max-width:60%;">
              </div>
              <form role="form" method="post" action="process/processforgot.php">
